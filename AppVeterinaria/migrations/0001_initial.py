    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_producto_cantidad_valor', models.CharField(db_column='nombre_producto-cantidad-valor', max_length=500)),
                ('fecha', models.DateTimeField()),
                ('valor', models.CharField(max_length=20)),
                ('valor_consulta', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
                'db_table': 'factura',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicamento_dosis', models.CharField(blank=True, db_column='Medicamento_dosis', max_length=500, null=True)),
            ],
            options={
                'db_table': 'registro',
                'managed': False,
